...
<section class="section">
    <div class="section-header">
        @php
            $tes = isset($kelas);
        @endphp
    <h1>Absensi @if ($tes)kelas  <span class=" text-danger">{{$kelas->nama}}</span> Semester <span class=" text-danger">{{$filter['id_semester']}} </span>@endif </h1>
    </div>
