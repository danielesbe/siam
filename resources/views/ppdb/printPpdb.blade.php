...
<script type="text/javascript">
	...
	function PrintDoc() {
		...
		popupWin.document.write('<html><title>KARTU Pendaftaran '+ nama +'</title></head><body onload="window.print()">')
...
<body><br><br>
    <input type="hidden" id="nama" value="{{$ppdb->nama}}">
                            ...
                            <tr>
                                <td width="100%">
                                    <div align="center" class="style3" size="10em"><span
                                            style="font-size: 20pt"><b>&nbsp;&nbsp;&nbsp;{{$ppdb->nomor_pendaftaran}}&nbsp;&nbsp;&nbsp;</b></span>
                                    </div>
                                </td>
                            </tr>
                        </table>
    ...
    <div class="container" id="kartu"
        ...
        <table width="103%">
            <tr align="left">
                ...
                <th id="nama" width="157" class="style10" style="font-size: 16px">Nama</th>
                <th style="font-size: 10pt"><span class="style10">:</span></th>
            <th width="380" style="font-size: 16px"> <span class="style10"><strong>{{$ppdb->nama}}
                        </strong></span></th>
            </tr>
            <tr align="left">
                ...
                <th style="font-size: 16px"><strong>{{$ppdb->nisn}} </strong></th>
            </tr>
            <tr align="left">
                <th style="font-size: 10pt">&nbsp;</th>
                <th class="style10" style="font-size: 16px">Tempat, Tgl. Lahir</th>
                <th style="font-size: 16px"><span class="style10">:</span></th>
                <th style="font-size: 16px"> <span class="style10"><strong>{{$ppdb->tempat_lahir}}, {{$ppdb->tanggal_lahir}}</strong></span>
                </th>
            </tr>
            <tr align="left">
                <th style="font-size: 10pt">&nbsp;</th>
                ...
                <th style="font-size: 16px"><span class="style10">:</span></th>
                <th style="font-size: 16px"> <span class="style10"><strong>{{$ppdb->jenis_kelamin=='L'?'Laki Laki':'Perempuan'}}</strong></span></th>
            </tr>
            <tr align="left">
                ...
                <th style="font-size: 16px"> <span class="style10"><strong>{{$ppdb->alamat}}
                            </strong></span></th>
            </tr>
            ...
            <tr align="left">
                ...
                <th style="font-size: 16px"><span class="style10">:</span></th>
                <th style="font-size: 16px"><span class="style10">{{$ppdb->nama_sekolah}}</span></th>
            </tr>
            <tr align="left">
