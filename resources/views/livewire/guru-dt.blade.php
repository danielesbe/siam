                        ...
                        <tbody>
                            <tr>
                                ...
                                <th wire:click="sortBy('nik')" style="cursor: pointer;">
                                    Nik
                                    @include('partials.sort-icon',['field'=>'nik'])
                                </th>
                                <th>Mapel</th>
                                <th>Action</th>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="badge badge-info">{{$row->nama}}</div>
                                    @endforeach
                                </td>
                                <td>

                                    <form onsubmit="return confirm('Apakah anda yakin ingin menghapus?');" action="{{ route('guru.destroy', $item->id) }}" method="post">
